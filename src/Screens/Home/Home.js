...
const Home = () => {
  return (
    <View style={{ backgroundColor: Colors.MainBlue, color: "white", height: "100%", paddingTop: 10, paddingHorizontal: 10 }}>
      <Text style={{ fontSize: 22, color: Colors.TextBlue, fontWeight: 500 }}>AssalamoAlaikum</Text>
      <Text style={{ letterSpacing: 1, fontSize: 28, color: 'white', fontWeight: 800, paddingTop: 5, }}>User </Text>
